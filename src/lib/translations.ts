...
export const translations = {
  ...
  ne: {
    ...
    toGive: "दिनु पर्ने",
    totalOutstanding: "कुल बाँकी सिलिन्डरहरू",
    owedToCustomers: "ग्राहकलाई दिनु पर्ने सिलिन्डरहरू",
    topToReceive: "धेरै पाउनु पर्ने",
    topToGive: "धेरै दिनु पर्ने",
    highestOutstanding: "उच्चतम बाँकी मौज्दात",
    collectionSchedule: "संकलन तालिका",
    overdue: "म्याद नाघेको",
    today: "आज",
    weekly: "साप्ताहिक",
    recentLogs: "भर्खरका रेकर्डहरू",
    ...
    statedBalance: "हालको मौज्दात",
    dateBs: "मिति (वि.सं.)",
    type: "प्रकार",
    qty: "परिमाण",
    running: "कुल बाँकी",
    fixBalance: "मौज्दात मिलाउनुहोस्",
    shareStatement: "स्टेटमेन्ट पठाउनुहोस्",
    activate: "सक्रिय गर्नुहोस्",
    deactivate: "निष्क्रिय गर्नुहोस्",
    quickLog: "द्रुत रेकर्ड",
    issueCylinder: "सिलिन्डर पठाउनुहोस्",
    returnCylinder: "सिलिन्डर फिर्ता लिनुहोस्",
    documentation: "कागजात",
    generalNotes: "सामान्य टिप्पणी",
    instructions: "निर्देशनहरू",
    confirmLog: "रेकर्ड पुष्टि गर्नुहोस्",
    movementLogged: "कारोबार रेकर्ड भयो",
    ...
    company: "कम्पनी",
    systemMaintenance: "प्रणाली मर्मत",
    backup: "ब्याकअप",
    restore: "रिस्टोर",
    language: "भाषा",
    english: "English",
    nepali: "नेपाली",
    saveConfiguration: "कन्फिगरेसन सुरक्षित गर्नुहोस्",
    settingsSaved: "सेटिङहरू सुरक्षित भयो",
    
    // Notifications & Validation
    success: "सफल",
    error: "त्रुटि",
    incompleteForm: "कृपया सबै आवश्यक क्षेत्रहरू भर्नुहोस्",

...
export const translations = {
  en: {
    ...
    topToReceiveRetailers: "Top To Receive (Retailers)",
    topToReceiveNonRetailers: "Top To Receive (Non-Retailers)",
    retailersOutstanding: "Highest outstanding (PAN registered)",
    ...
    // PDF & Reporting Specific
    reportDate: "Report Date",
    reportGenerated: "Report Generated",
    period: "Period",
    accountSummary: "Account Summary",
    totalIssued: "Total Issued (OUT)",
    totalReturned: "Total Returned (IN)",
    netBalanceCurrent: "Net Balance (Current)",
    computerGeneratedLedger: "Computer generated ledger. Powered by PGS Cylinder Ledger.",
    filterApplied: "Filter Applied",
    page: "Page",
    ledgerStatement: "Ledger Statement",
    customerLedgerReport: "Customer Ledger Report",
    debtorsList: "Debtors List (To Receive)",
    creditorsList: "Creditors List (To Give)",
    retailersSummary: "Retailers Summary",
    nonRetailersSummary: "Individual Accounts Summary",
  ...
  ne: {
    ...
    topToReceiveRetailers: "लिनु पर्ने (खुद्रा)",
    topToReceiveNonRetailers: "लिनु पर्ने (गैर-खुद्रा)",
    retailersOutstanding: "उच्चतम बाँकी (प्यान सहित)",
    ...
    // PDF & Reporting Specific
    reportDate: "रिपोर्टको मिति",
    reportGenerated: "रिपोर्ट तयार गरिएको",
    period: "अवधि",
    accountSummary: "खाताको सारांश",
    totalIssued: "कुल निकासी (OUT)",
    totalReturned: "कुल फिर्ता (IN)",
    netBalanceCurrent: "कुल बाँकी (हालको)",
    computerGeneratedLedger: "कम्प्युटरबाट उत्पन्न लेजर। PGS सिलिन्डर लेजर द्वारा संचालित।",
    filterApplied: "फिल्टर लागू गरिएको",
    page: "पृष्ठ",
    ledgerStatement: "खाता विवरण",
    customerLedgerReport: "ग्राहक खाता रिपोर्ट",
    debtorsList: "ऋणीहरूको सूची (लिनु पर्ने)",
    creditorsList: "साहुहरूको सूची (दिनु पर्ने)",
    retailersSummary: "खुद्रा बिक्रेता सारांश",
    nonRetailersSummary: "व्यक्तिगत खाता सारांश",
    settledAccounts: "चुक्ता गरिएका खाताहरू",
